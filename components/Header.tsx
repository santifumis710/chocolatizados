    ...
    <div className="max-w-[1200px] mx-auto">
      <div className="flex justify-between items-center w-full">
        ...
        <div className="flex items-center gap-2">
          ...
          <SocialIcon href={`https://api.whatsapp.com/send?phone=${process.env.NEXT_PUBLIC_WHATSAPP_BUSINESS_PHONE ?? "5493425334765"}&text=Hola%20Marie,%20quiero%20chocolates!`}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
